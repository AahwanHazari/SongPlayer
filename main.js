...
function draw(){
    ...
    if(song_1_Status == false){
        song1.play();
        document.getElementById("song_name").innerHTML="Believer ( Imagine Dragons)";
    }
    ...
    if(rightWristScore > 0.2){
        ...
        if(song_2_Status == false){
            song2.play();
            document.getElementById("song_name").innerHTML="Count On me ( Bruno Mars )";
        }
    }
}
